            ...
            <tbody className= "col-12">
              {cart.map((product, index) => (
                ...
                <tr key={uuid()}>
                  ...
                  <td scope="col" className= "align-middle">{product.kirjailija}</td>
                  <td scope="col" className= "align-middle">{product.kirjanimi}</td>
                  <td scope="col" className= "align-middle">{product.hinta}€</td>
                  <td scope="col" className= "align-middle">
                    <input
                      ref={inputs[index]}
                      style={{ width: '60px' }}
                  ...
                  <td scope="col" className= "align-middle">Yhteensä: {riviSumma} </td>
                  <td scope="col" className= "align-middle">
                    <a
                      className='order'
                      href='#'
